...
final class AuditChainTests: XCTestCase {
    ...
    func testCanonicalFormIsExactlyTheDocumentedString() {
        ...
        // Interpolated so no source line pairs a secret-ish keyword with the
        // fixture UUID — the gitleaks generic-api-key rule false-positives on
        // that (the constant name must not contain "secret" either).
        let fixtureRecordId = "a41c0d1e-2f30-4152-6374-8596a7b8c9da"
