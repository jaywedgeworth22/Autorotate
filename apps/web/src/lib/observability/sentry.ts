/**
 * Lightweight web Sentry client observability for Autorotate Web.
 *
 * Gated on VITE_SENTRY_DSN. Inert in dev/CI when unset.
 * Captures unhandled window errors and promise rejections, sending
 * sanitized Sentry envelope payloads with strict secret redaction.
 */
